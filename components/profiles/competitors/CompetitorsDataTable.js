...
export default function CompetitorsDataTable({ data, onSave }) {
  ...
  async function confirmDelete() {
    if (deleteModal.item) {
      ...
      const response = await fetch("/api/masterdata/competitors/delete", {
        body: datapass,
        headers: {
    ...
    <div className="container mt-4 font-sans text-gray-900">
      <div className="flex justify-between mb-4">
        ...
        <div className="space-x-2">
          ...
          <CSVLink data={filteredData} filename={"competitors_download.csv"}>
