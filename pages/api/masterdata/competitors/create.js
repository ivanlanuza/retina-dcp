...
export default async function handler(req, res) {
  ...
  try {
    ...
    return response.getSuccessResponse(res, 201, { newCompetitor });
  } catch (error) {
    return response.getFailedResponse(res, 500, { message: "Error creating competitor", error: error.message });
  }
}
